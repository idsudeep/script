...
$q = "select *from user_log where id = '$userid'";
    ...
    <div class="container">
        ...
        <div class="row">
                ...
                <div class="col-sm-6 offset-3">
                         <h2 style="padding :24px; text-align:center; margin-top:25px; margin-bottom: 12px;"> edit_user </h2>

                         <a href="user_log.php"><h5>View User Details</h5></a>
                <form method="POST" action="action.php?form=edit_user">
                    <input type="number" name="userid" value="<?php echo $row['id']; ?>" hidden>
                ...
                <div class="form-group">
                    ...
                    <input type="text" onkeyup="formValidate()" name ="contact"class="form-control" id="contact" placeholder="+97798"value ="<?php echo $row['contact'] ?>">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" id="pass" name="password "value ="<?php echo $row['password'] ?>">
                </div>
                <div class="form-group">
